...
% \bibfilename	-> The name of your BibTeX references file, without the .bib extension
...
% If files not needed in document, comment or remove line
...
% ========== Back Matter =================
% Files must be in same folder as working directory. Otherwise, include path, e.g., <current dir>/<backmatter>/*
...
\bibliographystyle{apacite} % TRY REMOVING THIS IF ERROR MESSAGE RECEIVED
